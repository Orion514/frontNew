...
import switchs from './options/switch'

export default defineComponent({
  setup() {
    const dom: Ref<HTMLDivElement> = ref(null) as any
    let myChart: echarts.ECharts | null = null
    let currentOption = switchs.sunburstOption
    onMounted(() => {
    ...
    setInterval(function () {
      (currentOption as any) = (currentOption as any) === switchs.sunburstOption ? switchs.treeMapOption : switchs.sunburstOption
      myChart!.setOption(currentOption)
    }, 3000);

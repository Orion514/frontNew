...
const menu = {
  ...
  /** 三级菜单2 */
  menu1_3: createNameComponent(() => import('@/views/main/menu/menu-1/menu-1-3.vue')),
  /** 三级菜单1 */
  menu2_1: createNameComponent(() => import('@/views/main/menu/menu-2/menu-2-1.vue')),
  /** 三级菜单1 */
  menu2_2: createNameComponent(() => import('@/views/main/menu/menu-2/menu-2-2.vue')),
  /** 三级菜单2 */
  menu2_3: createNameComponent(() => import('@/views/main/menu/menu-2/menu-2-3.vue')),
  /** 三级菜单1 */
  menu3_1: createNameComponent(() => import('@/views/main/menu/menu-3/menu-3-1.vue')),
  /** 三级菜单1 */
